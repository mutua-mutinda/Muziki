                ...
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                  <vee-form name="name" class="space-y-6" action="#" method="POST" :validation-schema="loginSchema" @submit="login" >
                    <div>
                      ...
                      <div class="mt-1">
                        <vee-field name="email" type="email" autocomplete="email"  class=" appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm " />
                    ...
                    <div>
                      ...
                      <div class="mt-1">
                        <vee-field name="password" type="password" autocomplete="password"  class=" appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm " />
